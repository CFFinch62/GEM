...
from app.ruby_language import RubyLanguageProvider
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Gem IDE")
        self.theme_manager = ThemeManager(self)
        self.language_provider: LanguageProvider = RubyLanguageProvider()
        self._settings = QSettings("GemIDE", "Gem IDE")
        self._setup_ui()
        self._setup_menus()
        self._setup_toolbar()
    ...
    def _create_new_tab(self) -> None:
        ...
        index = self.tabs.addTab(editor, "untitled.rb")
    ...
    def _show_about(self) -> None:
        ...
        about_box.setWindowTitle("About Gem IDE")
        about_box.setTextFormat(Qt.TextFormat.RichText)
        about_box.setText(
            "<h3>Gem IDE — Gem Development Environment</h3>"
            "<p><b>Version 0.1.0</b></p>"
            "<p>A beginner-friendly IDE for learning and teaching Gem.</p>"
    ...
    def _update_title(self) -> None:
        ...
        self.setWindowTitle(f"Gem IDE - {path_text}{dirty}")
